...
class Program
{
    static void Main(string[] args)
    {
        ...
        Address address3 = new Address("233 Kasoa Street", "Safari", "KS", "USA");
        Customer customer3 = new Customer("Benjamin Asante", address3);


        Product product1 = new Product("Laptop", "L123", 1000, 1);
        Product product2 = new Product("Mouse", "M456", 20, 2);
        Product product3 = new Product("Dell-Aio", "3277", 50, 1);
        Product product4 = new Product("Benz", "GLE27", 7000, 1);
